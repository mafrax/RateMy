...
var transporter = nodemailer.createTransport({
  ...
  port: '587',
  auth: {
	  user: 'admin@rateyourporn.com',
	  pass: '!MotdepasseRateyourporn1990'
  }
})

var mailOptions = {
  from: 'admin@rateyourporn.com',
  to: 'mongin.marc@gmail.com',
  ...
  function (req, email, password, done) {
    ...
    process.nextTick(function () {
      User.getBy('user.localEmail', email, function (err, user) {
        ...
        if (!User.validPassword(password, user.properties.localPassword)) { return done(null, false, req.flash('loginMessage', 'Oops! Wrong password.'))}
